...
const images: string[] = [
  "https://static.vecteezy.com/ti/vetor-gratis/p1/11000294-banner-abstrato-com-um-design-colorido-de-ondas-sonoras-de-musica-gratis-vetor.jpg",
...
const Carousel: React.FC = () => {
  ...
  return (
    <div className="relative w-full mx-auto mt-10">
      ...
      >
        <img src={images[currentIndex]} alt="Carousel slide" className="w-full h-72" />
      </div>
      <button
